...
-- instance Pretty (ParseError Char String) where
--   ppr _ (TrivialError sp m s) = text "lol"
--   ppr _ (FancyError sp s) = text "lol"


-- ppparseerror :: Scheme -> String
-- ppparseerror = render . ppr 0
...
ppsignature_ :: (String, Scheme) -> String
ppsignature_ (a, b) = a ++ " : " ++ ppscheme b
